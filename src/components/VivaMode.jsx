import { Bookmark, BookOpenText, ChevronDown, ChevronLeft, ChevronUp, Home, LayoutGrid, Mic, Star } from 'lucide-react'
...
export default function VivaMode() {
  ...
  const nonNailed       = questions.filter(q => !vivaMastered?.has(qid(q)))
