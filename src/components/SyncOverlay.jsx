...
`
const wrap = { position: 'fixed', inset: 0, zIndex: 2000, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 22, background: 'var(--bg)' }
const ring = { position: 'relative', width: 58, height: 58 }
const arc = { position: 'absolute', inset: 0, borderRadius: '50%', border: '3px solid transparent', borderTopColor: 'var(--accent)', borderRightColor: 'var(--accent)' }
const dot = { position: 'absolute', inset: 20, borderRadius: '50%', background: 'var(--accent-2)', animation: 'gq-pulse 1.4s ease-in-out infinite' }
